<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-800 leading-tight">
            {{ __('Edit Layanan Laundry') }} — {{ $service->name }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm">
                <form method="POST" action="{{ route('admin.services.update', $service->id) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1.5 w-full" type="text" name="name" :value="old('name', $service->name)" required autofocus />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3" class="block mt-1.5 w-full border-slate-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl shadow-sm" required>{{ old('description', $service->description) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="unit" name="unit" required class="block mt-1.5 w-full border-slate-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl shadow-sm">
                                ...
                                <option value="pcs" {{ old('unit', $service->unit) === 'pcs' ? 'selected' : '' }}>Satuan / Buah (pcs)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="price" class="block mt-1.5 w-full" type="number" name="price" :value="old('price', $service->unit === 'kg' ? $service->price_per_kg : $service->price_per_pcs)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="duration_hours" class="block mt-1.5 w-full" type="number" name="duration_hours" :value="old('duration_hours', $service->duration_hours)" required />
