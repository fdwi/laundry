    ...
    <div class="py-12" x-data="{ openModal: false, selectedOrder: {} }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
                <form method="GET" action="{{ route('kurir.orders.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    <!-- Filter Status -->
                    <div>
                    ...
                    <div class="flex space-x-2">
                        ...
                        <a href="{{ route('kurir.orders.index') }}" class="border border-slate-200 text-slate-500 hover:bg-slate-50 font-bold px-4 py-2.5 rounded-xl transition text-sm">
                            Reset
                        </a>
                    </div>
                </form>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100 text-sm">
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-12 text-center text-slate-400 italic">Tidak ditemukan pesanan laundry.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
